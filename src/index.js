...
export default class Headroom extends Component {
  ...
  getScrollerHeight = () => {
    ...
    return parent === window || parent === document.body ? this.getDocumentHeight() : this.getElementHeight(parent);
  };
  ...
  render() {
    ...
    const wrapperClassName = userClassName ? `${userClassName} headroom-wrapper` : "headroom-wrapper";
